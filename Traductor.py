...
with open('generated/diagram.xmi', 'r') as archivo:
    xmi_data = archivo.read()

# Archivo de salida CLIPS
clips_file = 'generated/output.clp'

try:
    root = parse_xmi('generated/diagram.xmi')
    ...
    # Ejecutar el motor de reglas CLIPS usando clipspy
